// [AIV]  Build version: 2.0.0-alpha.4.2 - Thursday, August 17th, 2017, 9:39:39 AM  
 var Bindery =
...
var Bindery = function () {
  function Bindery(opts) {
    ...
    console.log('Bindery ' + '2.0.0-alpha.4.2');
...
exports.default = function (title, text) {
  return (0, _hyperscript2.default)((0, _prefixClass2.default)('.error'), (0, _hyperscript2.default)((0, _prefixClass2.default)('.error-title'), title), (0, _hyperscript2.default)((0, _prefixClass2.default)('.error-text'), text), (0, _hyperscript2.default)((0, _prefixClass2.default)('.error-footer'), 'Bindery ' + '2.0.0-alpha.4.2'));
};
